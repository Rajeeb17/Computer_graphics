...
<CodeBlocks_project_file>
	...
	<Project>
		<Option title="PROJECTBRIDGE" />
		<Option pch_mode="2" />
		<Option compiler="gcc" />
		<Build>
			<Target title="Debug">
				<Option output="bin/Debug/PROJECTBRIDGE" prefix_auto="1" extension_auto="1" />
			...
			<Target title="Release">
				<Option output="bin/Release/PROJECTBRIDGE" prefix_auto="1" extension_auto="1" />
				<Option working_dir="C:/Program Files/CodeBlocks/MinGW/x86_64-w64-mingw32/bin" />
